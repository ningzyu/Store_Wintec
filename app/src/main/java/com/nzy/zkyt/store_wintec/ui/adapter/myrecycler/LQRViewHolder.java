...
public class LQRViewHolder extends RecyclerView.ViewHolder {
    ...
    protected LQRAdapterForRecyclerView.OnItemClickListener mOnItemClickListener;
    protected LQRAdapterForRecyclerView.OnItemLongClickListener mOnItemLongClickListener;
    protected LQRAdapterForRecyclerView.OnItemTouchListener mOnItemTouchListener;
    ...
    public LQRAdapterForRecyclerView.OnItemClickListener getOnItemClickListener() {
        return mOnItemClickListener;
    }

    public void setOnItemClickListener(LQRAdapterForRecyclerView.OnItemClickListener onItemClickListener) {
        mOnItemClickListener = onItemClickListener;
    }

    public LQRAdapterForRecyclerView.OnItemLongClickListener getOnItemLongClickListener() {
        return mOnItemLongClickListener;
    }

    public void setOnItemLongClickListener(LQRAdapterForRecyclerView.OnItemLongClickListener onItemLongClickListener) {
        mOnItemLongClickListener = onItemLongClickListener;
    }

    public LQRAdapterForRecyclerView.OnItemTouchListener getOnItemTouchListener() {
        return mOnItemTouchListener;
    }

    public void setOnItemTouchListener(LQRAdapterForRecyclerView.OnItemTouchListener onItemTouchListener) {
